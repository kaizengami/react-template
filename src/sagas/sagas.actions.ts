...
export const requestCollectionSuccess = (data: any) => {
...
export const requestCollectionDetailsSuccess = (data: any) => {
  return {
...
export const fetchCollectionDetails = (objectNumber: any) => {
